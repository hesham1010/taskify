...
const MarketingPage = () => {
    return (
        <div className="flex items-center justify-center flex-col">
            ...
            <div className="text-sm md:text-xl text-neutral-400 mt-4 max-w-xs md:max-w-2xl mx-auto">
            ...
            <Button className="mt-6" size="lg" > <Link href={'/sign-up'}>Get Taskify for free</Link></Button>
        </div>
    )
}
